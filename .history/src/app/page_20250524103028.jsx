              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    From vesting schedules to exit scenarios, Veston gives both
                    startup and mid-level professionals the tools to maximize
                    compensation and confidently navigate every equity
                    milestone.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2 max-w-[800px]">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Veston helps both startup and established company
                  professionals understand, track, and optimize their equity
                  compensation.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="space-y-2 max-w-[800px]">
                ...
                <p className="text-muted-foreground">
                  From free basics to premium features, we have options for
                  everyone
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Hear from people at startups and established companies who
                  have made better decisions about their equity with Veston.
                </p>
              </div>
            </div>
              ...
              <Card className="relative overflow-hidden border-blue-100">
                ...
                <CardContent>
                  <p className="text-muted-foreground italic">
                    ...
                    see how different growth trajectories would affect my RSUs
                    and options. This tool is essential for anyone with equity
                    compensation, whether at a startup or established company."
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join thousands of professionals at startups and established
                  companies making smarter decisions about their equity
                  compensation.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
