...
function TestimonialsLoading() {
  return (
    <div className="w-full py-12 md:py-24 lg:py-32 bg-gray-50 animate-pulse"></div>
  );
}
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Understand your startup equity's true value
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Intelligent scenario modeling for startup employees.
                    Maximize your compensation and make smarter decisions.
                  </p>
                </div>
