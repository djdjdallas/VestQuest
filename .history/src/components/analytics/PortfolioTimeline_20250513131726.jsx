...
// Fallback formatting function in case the utility isn't available
const formatCurrency = (value) => {
  // Use the utility function if available, otherwise use the fallback
  if (typeof utilsFormatCurrency === "function") {
    ...
    if (active && payload && payload.length) {
      return (
        <div className="bg-white p-4 rounded shadow border border-gray-200">
          <p className="font-semibold">{label || "N/A"}</p>
