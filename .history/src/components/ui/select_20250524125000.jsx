// 2. Updated Select component with failsafe styling:
"use client";
...
// 3. Test component to verify it's working:
    ...
    <div className="p-4 space-y-4">
      <div>
        <label className="block text-sm font-medium mb-2">
          Test Select (Current value: {value || "none"})
        </label>
      ...
      {/* Debug info */}
      <div className="mt-4 p-4 border rounded text-xs font-mono">
        <p>Debug Info:</p>
        <p>
          Body text color:{" "}
          <span className="text-foreground">Should be visible</span>
        </p>
        <p>
          Forced black: <span className="text-black">Black text</span>
        </p>
        <p>
          Forced white:{" "}
          <span className="text-white bg-black inline-block px-1">
            White text
          </span>
        </p>
      </div>
