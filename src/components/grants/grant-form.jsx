...
const formSchema = z.object({
  ...
  shares: z.number().min(1, { message: "Number of shares must be at least 1" }),
  strike_price: z.number().min(0, { message: "Strike price must be positive" }),
  ...
  current_fmv: z.number().min(0, { message: "FMV must be positive" }),
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            ...
                            {form.watch("grant_type") === "RSU" &&
                              " (usually N/A for RSUs)"}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                  ...
                  <div>
                    ...
                    <p
                      className={`font-medium ${
                        potentialGain >= 0 ? "text-green-600" : "text-red-500"
                      }`}
                    >
