...
const educationContent = [
  ...
  },
  {
    ...
    relatedTerms: ["Cliff", "Single-Trigger Acceleration", "Double-Trigger Acceleration", "Vesting Start Date"],
    isPremium: false,
  },
  {
  ...
  },
  {
    ...
    relatedTerms: ["Fair Market Value", "Strike Price", "Common Stock", "Preferred Stock"],
    isPremium: true,
  },
  {
    ...
    relatedTerms: ["Capitalization Table", "Down Round", "Anti-Dilution Provisions", "Option Pool"],
    isPremium: true,
  },
  {
    ...
    relatedTerms: ["Lock-up Period", "Earn-out", "Liquidity Event", "Secondary Market"],
    isPremium: true,
  },
];
...
const glossaryTerms = [
  ...
  },
  {
    ...
    relatedTerms: ["409A Valuation", "Strike Price", "Common Stock", "Preferred Stock"],
    isPremium: false,
  },
  {
    term: "Cliff",
    ...
    relatedTerms: ["Vesting Schedule", "Vesting", "Retention", "Grant Agreement"],
    isPremium: false,
  },
  {
  ...
  },
  {
    ...
    relatedTerms: ["Double-Trigger RSU", "Share Withholding", "Vesting", "Tax Withholding"],
    isPremium: false,
  },
  {
  ...
  },
  {
    ...
    relatedTerms: ["Safe Harbor", "Fair Market Value", "Common Stock", "Strike Price"],
    isPremium: false,
  },
  {
    ...
    relatedTerms: ["Participating Preferred", "Non-participating Preferred", "Waterfall Analysis", "Exit Proceeds"],
    isPremium: true,
  },
  {
    term: "83(b) Election",
    ...
    relatedTerms: ["Early Exercise", "Restricted Stock", "Capital Gains", "Tax Basis"],
    isPremium: true,
  },
];
...
const testimonials = [
  {
    quote: "VestQuest's educational resources helped me understand my equity package and negotiate a better offer that increased my compensation by over $50,000.",
    author: "Jessica K.",
  ...
  {
    quote: "I was completely lost about what to do with my stock options until I found these guides. The tax planning insights alone saved me thousands of dollars.",
    author: "Marcus T.",
  ...
  {
    quote: "The interactive calculators gave me the confidence to make informed decisions about my equity during our company's acquisition. Invaluable resource!",
    author: "Priya M.",
...
const quickQuizQuestions = [
  {
    question: "What happens when you have a 1-year cliff in your vesting schedule?",
    options: [
      { text: "You get 100% of your equity after 1 year", isCorrect: false },
      { text: "You get no equity until you've worked for 1 year, then 25% vests at once", isCorrect: true },
      { text: "Your equity vests 1% per month for the first year", isCorrect: false },
      { text: "You must exercise all options within 1 year", isCorrect: false }
    ]
  },
  {
    question: "What is the typical post-termination exercise window for stock options?",
    options: [
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 items-center">
        <div className="space-y-6">
          <h2 className="text-3xl font-bold">Understand Your Equity Compensation</h2>
          <p className="text-lg">
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Learn the basics of equity types, vesting, and key terminology.</p>
              </div>
            </div>
            <div className="flex items-start">
              <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-1" />
              <div>
                ...
                <p className="text-muted-foreground">Try our simplified calculators and visualizations to see how equity works.</p>
              </div>
            </div>
            <div className="flex items-start">
              <CheckCircle2 className="h-5 w-5 text-primary mr-2 mt-1" />
              <div>
                ...
                <p className="text-muted-foreground">Get clear explanations for complex concepts without the jargon.</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button size="lg" asChild>
              <Link href="#interactive-calculator">Try Interactive Calculator</Link>
            </Button>
        ...
        <div className="bg-muted p-8 rounded-xl">
          <div className="relative shadow-lg rounded-lg overflow-hidden border bg-card">
            ...
            <div className="p-6">
              <h3 className="text-lg font-semibold mb-4">Quick Equity Example</h3>
          ...
          {quizSubmitted ? (
            <div className="space-y-6">
              <div className="text-center py-4">
                <h3 className="text-xl font-medium mb-2">Your Score: {calculateQuizScore()}/{quickQuizQuestions.length}</h3>
                  ...
                  <div key={qIndex} className="border rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      {question.options.map((option, oIndex) => {
                        ...
                        let bgColor = "";
                        if (isSelected && isCorrect) bgColor = "bg-green-50 border-green-200";
                        else if (isSelected && !isCorrect) bgColor = "bg-red-50 border-red-200";
                        else if (!isSelected && isCorrect) bgColor = "bg-green-50 border-green-200";
            ...
            <div className="space-y-6">
                    ...
                    {question.options.map((option, oIndex) => (
                      <div 
                        ...
                        className={`border rounded p-2 cursor-pointer hover:bg-muted ${
                          quizAnswers[qIndex] === oIndex ? "bg-primary/10 border-primary" : ""
                        }`}
              ...
              <Button 
                ...
                disabled={Object.keys(quizAnswers).length < quickQuizQuestions.length}
              >
                Submit Answers
              </Button>
            </div>
      ...
      {/* Main content tabs */}
      <Tabs defaultValue="basics" value={activeTab} onValueChange={setActiveTab} className="w-full mb-16">
        ...
        <TabsContent value="basics" className="space-y-6 pt-4">
          ...
          <div className="relative mt-8 pt-8 border-t">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              {filteredEducationContent
                ...
                .slice(1)
                .map((item, index) => (
                  <Card key={index} className="h-full flex flex-col opacity-80 hover:opacity-100 transition-opacity">
          ...
          <div className="mt-8 flex justify-center">
            <Button asChild size="lg">
              <Link href="/register">
                Unlock All Advanced Topics <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          </div>
        </TabsContent>
        ...
        <TabsContent value="glossary" className="pt-4">
          ...
          <div className="relative mt-12 pt-8 border-t">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {filteredGlossaryTerms
                ...
                .map((item, index) => (
                  <GlossaryItem
                    ...
                    term={item.term}
                    definition={item.definition}
                    examples={item.examples && item.examples.length > 0 ? [item.examples[0]] : []}
                    relatedTerms={item.relatedTerms}
              ...
              {filteredGlossaryTerms
                ...
                .slice(1)
                .map((item, index) => (
                  <Card key={index} className="overflow-hidden transition-all hover:shadow-md opacity-75 hover:opacity-100">
                    <CardHeader className="pb-2">
          ...
          <div className="mt-8 flex justify-center">
            <Button asChild>
              <Link href="/register">
                Access Complete Equity Glossary <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          </div>
        </TabsContent>
        ...
        <TabsContent value="interactive" className="space-y-6 pt-4" id="interactive-calculator">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
            ...
            <CardFooter className="flex flex-col items-center space-y-4">
              <p className="text-center text-muted-foreground text-sm mb-2">
                This is a simplified calculator. For advanced features including:
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-8">
            <Card className="h-full flex flex-col justify-between">
              <CardHeader>
                ...
                <CardDescription>
                  Create personalized visual models of your vesting schedule and equity growth
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-muted aspect-video rounded-md flex items-center justify-center">
                  <div className="text-center px-6">
                    ...
                    <p className="text-muted-foreground">
                      Interactive vesting charts and valuation projections available with a free account
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="bg-muted aspect-video rounded-md flex items-center justify-center">
                  <div className="text-center px-6">
                    ...
                    <p className="text-muted-foreground">
                      Personalized equity timeline with key dates and notifications requires an account
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="relative overflow-hidden border-dashed opacity-90 hover:opacity-100 transition-opacity">
              ...
              <CardContent>
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                    <span>Acquisition payouts and retention bonus analysis</span>
                  </li>
                  <li className="flex items-center text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                    <span>Secondary market opportunities and considerations</span>
                  </li>
                </ul>
              </CardContent>
              <CardFooter>
          ...
          <div className="bg-muted rounded-lg p-8 mt-10">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-2/3 space-y-4">
                ...
                <h3 className="text-2xl font-bold">The Complete Equity Optimization Playbook</h3>
                <p>
                  Our comprehensive 85-page guide covers everything from grant evaluation to exit planning. 
                  With step-by-step walkthroughs, tax strategies, and decision frameworks.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
                    <span>Personalized decision tree based on your situation</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
                  ...
                  <div className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
                    <span>Expert-reviewed tax guidance and planning strategies</span>
                  </div>
                </div>
                <Button size="lg" asChild>
                  <Link href="/register">
              ...
              <div className="md:w-1/3 bg-background p-4 rounded-lg shadow-lg">
                <div className="aspect-[3/4] bg-muted rounded-md flex items-center justify-center relative">
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                    ...
                    <h4 className="text-lg font-bold mb-2">Equity Optimization Playbook</h4>
                    <p className="text-sm text-muted-foreground mb-4">Comprehensive guide with strategies, templates and tools</p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-3 p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-xl font-medium">Exercise Decision Guide</h3>
                  <p className="text-muted-foreground">
              ...
              <div className="pl-16">
                <p className="text-sm text-muted-foreground mb-4">
                  Answer a few questions about your grant, financial situation, and goals to receive guidance on:
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-center text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                    <span>Optimal exercise timing based on tax consideration</span>
                  </li>
                  <li className="flex items-center text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
            ...
            <div className="space-y-3 p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="pl-16">
                <p className="text-sm text-muted-foreground mb-4">
                  Create a customized exit strategy based on your goals, timing, and market conditions:
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-center text-sm">
                    <CheckCircle2 className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
              ...
              <AccordionItem value="preview">
                ...
                <AccordionContent>
                  <div className="p-4 border rounded-md space-y-4">
                    <p className="text-muted-foreground italic">This is a preview of our guided decision process. Full personalized guidance requires a free account.</p>
                    
                    <div className="space-y-3">
                      <h4 className="font-medium text-lg">Should you exercise your options now?</h4>
                      
                      <Alert>
                        <div className="font-medium">Based on general best practices:</div>
                        <div className="text-sm mt-2">
                          Early exercise may be advantageous when:
                          <ul className="list-disc pl-5 mt-1 space-y-1">
                            <li>The spread between strike price and FMV is small</li>
                            <li>You have strong belief in the company's growth</li>
                            <li>You can afford the exercise cost and associated taxes</li>
                            <li>You'll file an 83(b) election within 30 days (for early exercise)</li>
                          </ul>
                        </div>
                      </Alert>
                      
                      <div className="bg-muted p-4 rounded-md">
                        <h5 className="font-medium mb-2">For a personalized recommendation, we need to know:</h5>
                        <ul className="space-y-2">
                          <li className="flex items-center">
                            <Lock className="h-4 w-4 text-muted-foreground mr-2" />
                            <span className="text-muted-foreground">Your current financial situation</span>
                          </li>
                          <li className="flex items-center">
                            <Lock className="h-4 w-4 text-muted-foreground mr-2" />
                            <span className="text-muted-foreground">Details about your equity grant</span>
                          </li>
                          <li className="flex items-center">
                            <Lock className="h-4 w-4 text-muted-foreground mr-2" />
                            <span className="text-muted-foreground">Your risk tolerance and time horizon</span>
                          </li>
                          <li className="flex items-center">
                            <Lock className="h-4 w-4 text-muted-foreground mr-2" />
                            <span className="text-muted-foreground">Your tax situation and jurisdiction</span>
                          </li>
                        </ul>
                      </div>
      ...
      <div className="bg-muted rounded-xl p-8 mb-16">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            ...
            <h2 className="text-2xl font-bold">Equity Essentials: The Startup Employee's Guide</h2>
            <p>
              Get our free 15-page guide covering the fundamental concepts every startup employee should understand about equity compensation.
            </p>
            <ul className="space-y-2">
              <li className="flex items-center">
                <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
            ...
            {leadMagnetSubmitted ? (
              <Alert className="bg-primary/10 border-primary/20">
                ...
                <div className="ml-2">
                  ...
                  <div className="text-sm">Check your inbox for the download link</div>
                </div>
              </Alert>
            ) : (
            ...
            <div className="bg-card p-6 rounded-lg shadow-lg">
              <div className="aspect-[4/3] bg-muted rounded-md flex items-center justify-center relative">
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                  ...
                  <h4 className="text-xl font-bold mb-2">Equity Essentials Guide</h4>
                  <p className="text-sm text-muted-foreground mb-4">Your roadmap to understanding startup equity</p>
            ...
            <div className="order-2 md:order-1">
              <div className="bg-card shadow-lg rounded-lg overflow-hidden border">
                ...
                <div className="bg-muted/50 p-4 flex justify-center">
                  <Button variant="secondary" size="sm" disabled>Track Your Progress</Button>
                </div>
              </div>
            </div>
            <div className="order-1 md:order-2 space-y-4">
              <Badge>Learning Tracker</Badge>
              <h2 className="text-2xl font-bold">Track Your Equity Education Journey</h2>
              <p>
                Create a free account to track your progress through our educational content and receive personalized learning recommendations.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center">
                  <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
                ...
                <li className="flex items-center">
                  <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
                  <span>Get custom learning paths based on your equity situation</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
                  <span>Earn badges and certificates as you master concepts</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle2 className="h-4 w-4 text-primary mr-2" />
      ...
      <div className="mb-16">
        <div className="text-center max-w-2xl mx-auto mb-10">
          <h2 className="text-2xl font-bold mb-4">Put Your Knowledge Into Action</h2>
          <p className="text-muted-foreground">
            Now that you understand the basics, use these tools to make data-driven decisions about your equity.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Card className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <p className="mb-4">Comprehensive tools to value your equity, model exercise scenarios, and plan for exits.</p>
          ...
          <Card className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <p className="mb-4">Track your equity portfolio across multiple companies, grants, and vesting schedules.</p>
              <ul className="space-y-1 text-sm mb-4">
                <li className="flex items-center">
                  <CheckCircle2 className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
          ...
          <Card className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <p className="mb-4">Personalized guidance for making better decisions about your equity at critical moments.</p>
              <ul className="space-y-1 text-sm mb-4">
                <li className="flex items-center">
                  <CheckCircle2 className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
      ...
      <div className="text-center mb-16">
        <h2 className="text-3xl font-bold mb-4">Ready to Master Your Equity?</h2>
        <p className="text-muted-foreground max-w-xl mx-auto mb-8">
          Create your free account to access our full suite of educational resources, calculators, and personalized guidance.
        </p>
